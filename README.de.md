...
PyInstaller und Pillow sind in `requirements-build.txt` fest angeheftet. Tags wie `v1.1.0` testen und bauen Windows x64, macOS Apple Silicon und macOS Intel, prüfen Installer und DMGs, erzeugen SHA-256-Prüfsummen und veröffentlichen das Release.
